...
namespace DigitalRune.Windows.TextEditor
{
  ...
  public class TextArea : Control
  {
    ...
    /// </summary>
    /// <value><c>true</c> if selections should be cleared automatically; otherwise, <c>false</c>.</value>
    ...
    /// selection/position.
    /// </summary>
    /// <value><c>true</c> if cut/paste is enabled; otherwise, <c>false</c>.</value>
    ...
    /// </summary>
    /// <returns>A pair of matching brackets (or <c>null</c>).</returns>
