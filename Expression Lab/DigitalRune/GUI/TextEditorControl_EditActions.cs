...
namespace DigitalRune.Windows.TextEditor
{
  partial class TextEditorControl
  {
    ...
    /// <returns>
    /// 	<c>true</c> if the key is associated with an edit action; otherwise, <c>false</c>.
    /// </returns>
    ...
    /// </summary>
    /// <param name="keyData">The key data.</param>
    /// <returns>The edit action. (<c>null</c> if no action is bound to <paramref name="keyData"/>.)</returns>
